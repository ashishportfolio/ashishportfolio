        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-10 px-[6%] md:px-[8%] pointer-events-auto items-center">
          ...
          <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left">
            ...
            >
              ...
              <p className="text-[10px] md:text-[11px] font-sans font-bold tracking-[0.1em] text-fg capitalize opacity-90">
                Art Director . Mumbai
              </p>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col justify-center items-center md:items-end text-center md:text-left">
            ...
            >
              <p className="text-[10px] md:text-[12px] font-sans leading-[1.6] text-muted font-normal">
                Mumbai-based Art Director crafting bold visual identities, cinematic brand experiences, and culturally-driven digital narratives. Focused on blending strategy, motion, and storytelling into visually immersive work.
              </p>
            </motion.div>
          </div>
        </div>
